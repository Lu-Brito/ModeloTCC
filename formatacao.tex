...
\usepackage{hyperref}
% Informações do PDF
\hypersetup{ colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=DEPARTAMENTO DE CIÊNCIA DA COMPUTAÇÃO - UFRJ, pdfauthor=, pdfsubject=, pdfkeywords=}
